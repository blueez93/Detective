# Mod Detective — Codex instructions

## Project
Mod Detective is a client-side Minecraft diagnostic mod for Minecraft 1.21.1 using NeoForge and Java 21.
...
## Current milestone
The current milestone is **v0.1 engine validation**. Do not build the full UI yet.
...
- Avoid network calls and telemetry in v0.1.
- Do not add third-party runtime dependencies unless clearly justified.
- Keep persistent output under the Mod Detective data directory and avoid touching unrelated player files.
...
5. Inspect logs for Mod Detective startup errors.
